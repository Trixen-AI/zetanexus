...
export function Developers() {
  ...
  const base = ENV.apiUrl || '<VITE_ZETANEXUS_API_URL>';
  ...
  return (
    <>
      <PageHead index="05" title="Developers" lede="Wire ZetaNexus into your backend: create checkouts over the API and verify signed webhooks." />
      ...
      <div className="dash-grid-2">
        <section className="dash-panel">
          ...
          <div className="dash-kvs">
            ...
            <KV k="API base URL">
              <span className="num dash-break">{ENV.apiUrl || 'VITE_ZETANEXUS_API_URL is empty'}</span>
            </KV>
            <KV k="Chain">
          ...
          {!apiConfigured() ? (
            <p className="dash-note">
              Shielded ZEC addresses come from the checkout API. Set <code>VITE_ZETANEXUS_API_URL</code> in <code>.env</code> and
        ...
        <section className="dash-panel">
          ...
          <p className="dash-note">
            Every webhook carries <code>x-zetanexus-signature: sha256=&lt;hex&gt;</code>, an HMAC-SHA256 of the raw body with this
